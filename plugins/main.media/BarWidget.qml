...
BarWidget {
  id: root
  moduleName: "main.media"

  readonly property var mediaService: bar?.shell?.serviceFor("main.media")
  readonly property var activePlayer: mediaService ? mediaService.activePlayer : null
  readonly property var sourcePlayers: mediaService ? mediaService.sourcePlayers : []

  readonly property bool hasMedia: activePlayer !== null && (activePlayer.trackTitle || activePlayer.trackArtist || activePlayer.identity || activePlayer.desktopEntry)
  readonly property string playIcon: activePlayer && activePlayer.isPlaying ? "󰏤" : "󰐊"
  readonly property string title: activePlayer ? (activePlayer.trackTitle || "") : ""
  readonly property string artist: activePlayer ? (activePlayer.trackArtist || "") : ""
  readonly property string appName: activePlayer ? (activePlayer.identity || activePlayer.desktopEntry || "") : ""
  ...
  Row {
    ...
    Item {
      ...
      clip: true
      anchors.verticalCenter: parent.verticalCenter
      visible: !root.bar.vertical && root.appName !== ""
  ...
  MouseArea {
    ...
    onEntered: if (root.bar) root.bar.showTooltip(root, root.appName ? (root.appName + (root.title ? " — " + root.title : "") + (root.artist ? " — " + root.artist : "")) : "")
